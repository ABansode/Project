...
public class EmployeeController {
	...
	public boolean insertUserRegistrationData(
			@RequestBody UserRegistration userRegistration) {

		boolean flag = employeePayRollserviceEmployeeService
				.insertUserRegistrationData(userRegistration);
	...
	public EmployeeRegistration getEmployeeDetails(@PathVariable int employeeId) {
		...
		return employeePayRollserviceEmployeeService
	...
	public void getDataforGenrateMontlySalary(
			@RequestBody MonthlySalaryGenrate monthlySalaryGenrate) {
	...
	@GetMapping("/getApprisalList/{empid}")
	public List<UserApprisal> getApprisalList(@PathVariable("empid") int empid) {
		System.out.println("controller " + empid);
		return employeePayRollserviceEmployeeService.getApprisalList(empid);
	}

	@PostMapping("/approve")
	public List<UserApprisal> approveApprisal(@RequestBody UserApprisal userApprisal) {
		System.out.println(userApprisal.getApprisal_value() + " "
				+ userApprisal.getUser_id());
		int i=employeePayRollserviceEmployeeService.approveApprisal(userApprisal);
		return this.getApprisalList(userApprisal.getEmpid());
	}
}
